...
class Utils
{
    public static function buttonCTA($orderID, $select) : string
    {
        ...
        elseif($select == 2)
        {
            $button = '<a href="#contact-us" class="btn btn-primary">Zadat poptávku</a>';
        }
        elseif($select == 3)
        {
        ...
        elseif($select == 4)
        {
            $button = '<a href="#contact-us" class="btn btn-primary"><i class="fa-solid fa-share-nodes pe-2"></i>Sociální sítě</a>';            
        }
        else
        {
